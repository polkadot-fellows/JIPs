...
- `genesis_state` - An object defining genesis state. Each key is a 62-characted hex string defining the 31-byte state key. The values are arbitrary length hex strings.
